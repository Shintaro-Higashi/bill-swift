...
const modelFieldDefinitions: ModelWithFields[] = [{
        ...
        fields: [{
                ...
                name: "patient",
                type: "Patient",
                relationName: "AccountManageToPatient"
            }, {
...
type HealthFacilityaccountManageFactory = {
    _factoryFor: "AccountManage";
    build: () => PromiseLike<Prisma.AccountManageCreateNestedOneWithoutHealthFacilityInput["create"]>;
};
...
type HealthFacilityFactoryDefineInput = {
    ...
    accountManage?: HealthFacilityaccountManageFactory | Prisma.AccountManageCreateNestedOneWithoutHealthFacilityInput;
...
function isHealthFacilityaccountManageFactory(x: HealthFacilityaccountManageFactory | Prisma.AccountManageCreateNestedOneWithoutHealthFacilityInput | undefined): x is HealthFacilityaccountManageFactory {
    ...
    const getFactoryWithTraits = (traitKeys: readonly HealthFacilityTraitKeys<TOptions>[] = []) => {
        ...
        const build = async (inputData: Partial<Prisma.HealthFacilityCreateInput> = {}) => {
            ...
            const defaultAssociations = {
                ...
                accountManage: isHealthFacilityaccountManageFactory(defaultData.accountManage) ? {
...
type PatientaccountManageFactory = {
    _factoryFor: "AccountManage";
    build: () => PromiseLike<Prisma.AccountManageCreateNestedOneWithoutPatientInput["create"]>;
};
...
type PatientFactoryDefineInput = {
    ...
    accountManage?: PatientaccountManageFactory | Prisma.AccountManageCreateNestedOneWithoutPatientInput;
...
function isPatientaccountManageFactory(x: PatientaccountManageFactory | Prisma.AccountManageCreateNestedOneWithoutPatientInput | undefined): x is PatientaccountManageFactory {
    return (x as any)?._factoryFor === "AccountManage";
}
    ...
    const getFactoryWithTraits = (traitKeys: readonly PatientTraitKeys<TOptions>[] = []) => {
        ...
        const build = async (inputData: Partial<Prisma.PatientCreateInput> = {}) => {
            ...
            const defaultAssociations = {
                ...
                accountManage: isPatientaccountManageFactory(defaultData.accountManage) ? {
                    create: await defaultData.accountManage.build()
                } : defaultData.accountManage,
