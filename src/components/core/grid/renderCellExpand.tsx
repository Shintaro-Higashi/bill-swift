...
/**
 * MUI Data Grid の 各cell renderに利用するコンポーネント定義です。
 * <pre>
 * セル内で3点リーダー表記になった場合、PopOverを利用して全体をtooltip表示します。
 * セル内でtextarea情報を表示する場合に利用します。
 * 公式サンプル https://mui.com/x/react-data-grid/column-definition/
 * を取り込んだ内容になっています。
 *
 * </pre>
 */
...
export const RenderCellExpand = (params: GridRenderCellParams<any, string>) => {
