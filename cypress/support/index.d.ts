...
declare namespace Cypress {
  interface Chainable {
    ...
    resourceCreate(params: IResourceCreateParams): Chainable<JQuery<HTMLElement>>
    ...
    getMaterialUIFormItemError(params: IGetChakraUIFormItemErrorParams): Chainable<JQuery<HTMLElement>>
