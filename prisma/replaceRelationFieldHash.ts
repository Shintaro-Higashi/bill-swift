...
const replacements: { search: string; replace: string }[] = [
  ...
  // ユーザ
  { search: 'userUserCreatedByTouser', replace: 'createdUser' },
  { search: 'userUserUpdatedByTouser', replace: 'updatedUser' },
  {
    search: 'healthFacilityCodeGroupHealthFacilityCodeGroupCreatedByTouser',
    replace: 'healthFacilityCodeGroupCreatedUser',
  },
  {
    search: 'healthFacilityCodeGroupHealthFacilityCodeGroupUpdatedByTouser',
    replace: 'healthFacilityCodeGroupUpdatedUser',
  },
  ...
  {
    search: 'pharmacyBaseCompoundingSettingPharmacyBaseCompoundingSettingUpdatedByTouser',
    replace: 'pharmacyBaseCompoundingSettingUpdatedUser',
  },
  ...
  {
    search: 'healthFacilityCodeManageHealthFacilityCodeManageCreatedByTouser',
    replace: 'healthFacilityCodeManageCreatedUser',
  },
  {
    search: 'healthFacilityCodeManageHealthFacilityCodeManageUpdatedByTouser',
    replace: 'healthFacilityCodeManageUpdatedUser',
  },
  {
    search: 'healthFacilityRelatePharmacyHealthFacilityRelatePharmacyCreatedByTouser',
    replace: 'healthFacilityRelatePharmacyCreatedUser',
  },
  {
    search: 'healthFacilityRelatePharmacyHealthFacilityRelatePharmacyUpdatedByTouser',
    replace: 'healthFacilityRelatePharmacyUpdatedUser',
  },
  {
    search: 'patientRelateHealthFacilityPatientRelateHealthFacilityCreatedByTouser',
    replace: 'patientRelateHealthFacilityCreatedUser',
  },
  {
    search: 'patientRelateHealthFacilityPatientRelateHealthFacilityUpdatedByTouser',
    replace: 'patientRelateHealthFacilityUpdatedUser',
  },
